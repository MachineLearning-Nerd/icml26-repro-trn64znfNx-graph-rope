...
|---|---|---|
| Scope | Three theory claims plus author code-path attestation | Training and benchmark tables |
| Hardware | CPU, standard Python | Accelerators and datasets as required |
| Time | About 20 seconds | Not run |
| Cost | 0 dollars | Not estimated |
| Outcome | Passed | Out of scope |
